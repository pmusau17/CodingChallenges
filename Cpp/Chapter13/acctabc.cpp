...
#include "acctabc.h" // abstract base class and class declarations 
...
{
    ios_base::fmtflags initstate = SetFormat();
    cout << "Brss Client: " << FullName() << endl;
    cout << "Account Number: " << AcctNum() << endl;
    cout << "Balance: $" << Balance() << endl;
    cout.setf(initstate); // restore original format
}
